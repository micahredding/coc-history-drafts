...
A(Q('&hellip;that all his pious hearers, &ldquo;who felt so disposed and duly prepared, should, <b>without respect to party differences</b>, enjoy the benefits of the communion season then providentially afforded them.&rdquo;', 'Richardson, <i>Memoirs</i> 1:224', 'He did not fence the table') +
  '<aside class=notes>Richardson 1:224: he invited &ldquo;all his pious hearers, who felt so disposed and duly prepared,&rdquo; to the table &ldquo;without respect to party differences.&rdquo; What he actually did, as the prosecution&rsquo;s own witness described it, is the next slide. Asked why he did not fence the table, Wilson said Campbell gave as his reason &ldquo;the care that was taken by the session in not admitting such gross characters&rdquo; &mdash; the session had already examined the communicants; he would not add a doctrinal gate on top.</aside></section>')

A(Q('&ldquo;&hellip;he would propose our terms of communion: <b>1st. The Scriptures</b>; and that where there was a plain precept, that he who runs might read. <b>2d. The Westminster Confession of faith</b>; and this not particularly but generally&hellip; <b>3d. A testimony</b>: but this not particularly, but generally; for to require it as a particular term of communion would be to require <b>an implicit faith</b>.&rdquo;', 'William Wilson&rsquo;s sworn deposition &middot; Chartiers Presbytery, Buffaloe, 10 February 1808', 'What the prosecution&rsquo;s own witness said he did at the table') +
  '<aside class=notes>The only account of the fencing, and it is the accuser&rsquo;s. Wilson said Campbell told them they had &ldquo;on former occasions heard the precepts of the moral law gone over in setting a fence about the table; but this he considered unnecessary.&rdquo; Scripture first; the Confession and the Testimony only &ldquo;generally,&rdquo; because &ldquo;there were many things that were not proven, and others that could not be agreed to&rdquo; &mdash; he named the magistrate&rsquo;s power. <i>Implicit faith</i> is the Protestant name for Rome&rsquo;s demand that you believe what the church believes without knowing what it is. He is telling a room of Seceders that their fence is that. (Hanna ch. III, from the minutes, pp. 145&ndash;46.)</aside></section>')
